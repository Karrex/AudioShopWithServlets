...
public class DemoCharacterStreams {

    private static final Logger logger = Logger.getLogger(DemoCharacterStreams.class.getName());

    public static void main(String[] args) {
        File file = new File("demo.txt");

        DemoCharacterStreams demoByteStreams = new DemoCharacterStreams();
